...
If you find yourself wishing for a feature that doesn't exist in Ambiorix (in general) or wan-manager (specific), you are probably not alone. Open an issue/ticket which describes the feature you would like to see, why you need it, and how it should work.
